...
public class MathApplication {
    public static void main(String[] args) {
        ...
        double joeSalary = 150000.00;
        double daveSalary = 100000.50;
        double highestSalary = Math.max(joeSalary, daveSalary);
        System.out.println("1. The highest salary is " + highestSalary);

        //question 2 - automotives, find min
        double sedanPrice = 25500.25;
        double suvPrice = 46000.60;
        double lowestPrice = Math.min(sedanPrice, suvPrice);
